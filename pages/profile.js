...
function Profile() {
    ...
    const submitHandler = async ({ name, email, password, confirmPassword }) => {
     ...
     return (
        <Layout title="Редактирвоание профиля">
                ...
                <Grid container spacing={1}>
                            ...
                            <List>
                                <Link href="/profile" passHref>
                                    <ListItem selected button component="a">
                                        <ListItemText primary="Профиль пользователя"></ListItemText>
                                    </ListItem>
                                </Link>
                                <Link href="/order-history" passHref>
                                    <ListItem button component="a">
                                        <ListItemText primary="История покупок"></ListItemText>
                                    </ListItem>
                                </Link>
                            </List>
                        </Card>
                    ...
                    <Grid item md={9} xs={12}>
                        <Card>
                            <List>
                                <ListItem>
                                    <Typography variant="h4">Редактирвоание профиля</Typography>
                                </ListItem>
                                <ListItem>
