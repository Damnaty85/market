...
export default function Register() {
    ...
    return (
        <Layout title="Register">
            <form onSubmit={handleSubmit(submitHandler)} style={{width: '800px'}}>
                <Typography variant="h4">Register</Typography>
                    <List>
                        ...
                        <Controller 
                            ...
                            render={({ field }) => (
                                <TextField variant="outlined" fullWidth id="name" label="Name" inputProps={{ type: 'name' }} error={Boolean(errors.name)}
                                    helperText={
                                        errors.name
